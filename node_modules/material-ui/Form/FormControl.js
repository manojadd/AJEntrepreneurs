  ...
  (0, _createClass3.default)(FormControl, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          error = _props2.error,
          marginForm = _props2.marginForm,
          other = (0, _objectWithoutProperties3.default)(_props2, ['children', 'classes', 'className', 'disabled', 'error', 'marginForm']);


      return _react2.default.createElement(
        'div',
        (0, _extends3.default)({
          className: (0, _classnames2.default)(classes.root, (0, _defineProperty3.default)({}, classes.marginForm, marginForm), className)
        }, other, {
          onFocus: this.handleFocus,
          onBlur: this.handleBlur
        }),
...
FormControl.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  marginForm: _propTypes2.default.bool,
  /**
   * @ignore
   */
